    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-8">
      <div className="max-w-4xl w-full bg-black bg-opacity-50 rounded-lg shadow-lg p-6 sm:p-10">
        ...
        <div className="flex justify-center">
          <Link href="/game" className="bg-purple-600 hover:bg-orange-700 text-white font-bold py-3 px-6 rounded-full text-lg sm:text-xl transition-colors duration-200 transform hover:scale-105">
            Start Game
          </Link>
        </div>
      </div>
