...
export default function AuthLoader({ children }: Props) {
    ...
    if (status === "unauthenticated") {
        // Instead of redirecting, we'll just return null
        // This allows the parent component to handle unauthenticated state
        return null
    }
